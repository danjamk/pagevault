...
export interface Env {
  ...
  /**
   * The Browser Run (Puppeteer) binding — optional. Present enables PDF export (#50; one
   * continuous page, or the document's own paper when it declares `@page` — ADR-027);
   * absent means this deployment opted out, and both the PDF button and the endpoint
