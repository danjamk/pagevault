 ...
 * login. The full build (#22, task "Access as the upstream IdP") puts Cloudflare Access in
 * front of this so the operator logs in as themselves and the token is never typed into a
 * form. Do not ship this consent screen to prod as-is.
 */
